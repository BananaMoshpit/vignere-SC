...
//!FIXME: decrypt not work, encrypt work?
#include <bits/stdc++.h>
...
//!TODO: USE MEAN FREQ FOUND FOR ALL
...
int find_key_size(const string data){
    ...
    while (keySizeGuess >= 0){
        ...
        cout << "digite outro tamanho de chave para teste ou -1 para escolher este tamanho: " << endl;
        cin >> opt ;
        if(opt >= 0){
            keySizeGuess = opt;
        }
...
//!FIXME: wdf those ngroup frequencies r unsimilar numbers 
