...
const static char FIRST_CHAR = 00; //
...
int main(){
   ...
   data = read_from_in("in.txt"); 
    ...
    break_vigenere("Three days of rest, three blessed days of rest, are what I had with Wolf Larsen, eating at the cabin  able and doing nothing but discuss life, literature, and the universe, the while  Hi my name is slim shady beak it crawling pieces of somewjer beyond the rainbow", key.size(), ENG );
    //cout << enc;
